...
Mirrors the behavior of scripts/bash/update-agent-context.sh:
 ...
 5. Multi-Agent Support (claude, gemini, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, roo, codebuddy, amp, shai, q, agy, bob, droid, qodercli)
...
param(
    ...
    [ValidateSet('claude','gemini','copilot','cursor-agent','qwen','opencode','codex','windsurf','kilocode','auggie','roo','codebuddy','amp','shai','q','agy','bob','droid','qodercli','generic')]
    [string]$AgentType
)
...
function Update-SpecificAgent {
    ...
    switch ($Type) {
        ...
        default { Write-Err "Unknown agent type '$Type'"; Write-Err 'Expected: claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|kilocode|auggie|roo|codebuddy|amp|shai|q|agy|bob|droid|qodercli|generic'; return $false }
    }
}
...
function Print-Summary {
    ...
    Write-Host ''
    Write-Info 'Usage: ./update-agent-context.ps1 [-AgentType claude|gemini|copilot|cursor-agent|qwen|opencode|codex|windsurf|kilocode|auggie|roo|codebuddy|amp|shai|q|agy|bob|droid|qodercli|generic]'
}
